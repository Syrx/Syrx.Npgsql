...
using Syrx.Connectors.Databases.Npgsql;
...
namespace Syrx.Tests.Common
{
    ...
    {
        public static ICommander<T> UseNpgsql<T>(
            string settingsFile = "Syrx.Npgsql.Integration.Tests.json")
        {
            ...
            var connector = new NpgsqlDatabaseConnector(settings);
